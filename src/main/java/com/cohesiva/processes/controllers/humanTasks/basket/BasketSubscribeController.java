...
@Controller
public class BasketSubscribeController extends HumanTaskBaseController {

	@RequestMapping(value = "/basketSubProcess/confirm/{taskId}/{processInstanceId}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/subscribeBasket/confirm/handle_complete_task", params = "accept", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/subscribeBasket/confirm/handle_complete_task", params = "decline", method = RequestMethod.POST)
